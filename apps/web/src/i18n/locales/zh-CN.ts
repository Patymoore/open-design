...
export const zhCN: Dict = {
  ...
  'settings.welcomeTitle': '先生成一个结果',
  'settings.welcomeSubtitle': '告诉 Open Design 你想做什么，给一点素材，然后用 AMR 新手额度生成一个首版。',
  ...
  'settings.onboardingStepConnect': '目标',
  ...
  'settings.onboardingGithubTitle': '粘贴官网 URL',
  'settings.onboardingGithubBody': '使用产品、文档或品牌官网。',
  'settings.onboardingUploadTitle': '上传文件',
  'settings.onboardingUploadBody': '添加截图、PPT、PDF、文档或参考图。',
  'settings.onboardingPromptTitle': '写一句需求',
  'settings.onboardingPromptBody': '描述产品、品牌或目标结果。',
